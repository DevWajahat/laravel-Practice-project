                        ...
                        <svg width="135px" height="29px" viewBox="0 0 155 29" version="1.1"
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                ...
                                <g id="Group" transform="translate(-108.000000, -297.000000)" fill="#000000">
                                    <text id="AVIATO">
                                        <tspan x="108.94" y="325">{{ session('brand') }}</tspan>
                                    </text>
                                </g>
                            </g>
                        </svg>
                    ...
                    <li class="dropdown cart-nav dropdown-slide">
                        ...
                        <div class="dropdown-menu cart-dropdown">
                            ...
                            <div class="media">
                                <a class="pull-left" href="#!">
                                    <img class="media-object"
                                        src="{{ asset('assets/web/images/shop/cart/cart-2.jpg') }}" alt="image" />
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="#!">Ladies Bag</a></h4>
                                    <div class="cart-price">
                ...
                <ul class="nav navbar-nav">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    <ul>
                                        ...
                                        <li role="separator" class="divider"></li>
                                        <li><a href="{{ route('dashboard.index') }}">User Interface</a></li>
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    <a href="{{ route('products.index') }}">
                                        <img class="img-responsive"
                                            src="{{ asset('assets/web/images/shop/header-img.jpg') }}"
                                            alt="menu image" />
                                    </a>
                                </div>
                            </div><!-- / .row -->
                    ...
                    <li class="dropdown dropdown-slide">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('blogs.index') }}">Blog Left Sidebar</a></li>
                            <li><a href="blog-right-sidebar.html">Blog Right Sidebar</a></li>
                            <li><a href="blog-full-width.html">Blog Full Width</a></li>
                            <li><a href="blog-grid.html">Blog 2 Columns</a></li>
                            <li><a href="{{ route('blogs.articles') }}">Blog Single</a></li>
                        </ul>
                    </li><!-- / Blog -->

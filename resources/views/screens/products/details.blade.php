		...
		<div class="row">
			...
			<div class="col-md-6">
				<ol class="product-pagination text-right">
					<li><a href="{{ route('blog') }}"><i class="tf-ion-ios-arrow-left"></i> Next </a></li>
					<li><a href="{{ route('blog') }}">Preview <i class="tf-ion-ios-arrow-right"></i></a></li>
				</ol>
			</div>
		</div>
		<div class="row mt-20">
			...
			<div class="col-md-7">
				<div class="single-product-details">
					...
					<div class="product-category">
						...
						<ul>
							<li><a href="{{ route('singleProduct') }}">Products</a></li>
							<li><a href="{{ route('singleProduct') }}">Soap</a></li>
						</ul>
					</div>
